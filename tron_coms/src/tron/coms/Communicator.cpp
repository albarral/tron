...
void Communicator::addChannelReader(std::string node, std::string section, std::string channel, int type)
{
...
void Communicator::addChannelWriter(std::string node, std::string section, std::string channel, int type)
{
