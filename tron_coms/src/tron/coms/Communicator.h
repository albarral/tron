...
public:
    ...
    void addChannelReader(std::string node, std::string section, std::string channel, int type);
    void addChannelWriter(std::string node, std::string section, std::string channel, int type);
};
