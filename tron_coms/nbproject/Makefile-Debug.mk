...
${OBJECTDIR}/src/tron/coms/ChannelWriter.o: src/tron/coms/ChannelWriter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/coms
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I/usr/include/ignition/transport3 -I/usr/include/ignition/msgs0 -I/usr/include/ignition/math2 -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/coms/ChannelWriter.o src/tron/coms/ChannelWriter.cpp

${OBJECTDIR}/src/tron/coms/Communicator.o: src/tron/coms/Communicator.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/coms
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I/usr/include/ignition/transport3 -I/usr/include/ignition/msgs0 -I/usr/include/ignition/math2 -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/coms/Communicator.o src/tron/coms/Communicator.cpp
...
${OBJECTDIR}/src/tron/coms/ComsReceiver.o: src/tron/coms/ComsReceiver.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/coms
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I/usr/include/ignition/transport3 -I/usr/include/ignition/msgs0 -I/usr/include/ignition/math2 -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/coms/ComsReceiver.o src/tron/coms/ComsReceiver.cpp

${OBJECTDIR}/src/tron/coms/ComsSender.o: src/tron/coms/ComsSender.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/coms
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I/usr/include/ignition/transport3 -I/usr/include/ignition/msgs0 -I/usr/include/ignition/math2 -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/coms/ComsSender.o src/tron/coms/ComsSender.cpp
