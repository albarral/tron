...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/librobot.${CND_DLIB_EXT}

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/librobot.${CND_DLIB_EXT}: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/librobot.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -fPIC
...
${OBJECTDIR}/src/tron/robot/topics/BodyTopics.o: src/tron/robot/topics/BodyTopics.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/robot/topics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/robot/topics/BodyTopics.o src/tron/robot/topics/BodyTopics.cpp

${OBJECTDIR}/src/tron/robot/topics/NodeTopics.o: src/tron/robot/topics/NodeTopics.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/robot/topics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/robot/topics/NodeTopics.o src/tron/robot/topics/NodeTopics.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/librobot.${CND_DLIB_EXT}
