...
${OBJECTDIR}/src/tron/util/Click.o: src/tron/util/Click.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/util/Click.o src/tron/util/Click.cpp

${OBJECTDIR}/src/tron/util/Code.o: src/tron/util/Code.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/util
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/util/Code.o src/tron/util/Code.cpp

${OBJECTDIR}/src/tron/util/CodeInterpreter.o: src/tron/util/CodeInterpreter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/util
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/util/CodeInterpreter.o src/tron/util/CodeInterpreter.cpp
...
${OBJECTDIR}/src/tron/util/Environment.o: src/tron/util/Environment.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/util
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/util/Environment.o src/tron/util/Environment.cpp

${OBJECTDIR}/src/tron/util/IntegerQueue.o: src/tron/util/IntegerQueue.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/util
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/util/IntegerQueue.o src/tron/util/IntegerQueue.cpp

${OBJECTDIR}/src/tron/util/MessageQueue.o: src/tron/util/MessageQueue.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/util
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/util/MessageQueue.o src/tron/util/MessageQueue.cpp

${OBJECTDIR}/src/tron/util/Pool.o: src/tron/util/Pool.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/util
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/util/Pool.o src/tron/util/Pool.cpp

${OBJECTDIR}/src/tron/util/StringUtil.o: src/tron/util/StringUtil.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/util
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/util/StringUtil.o src/tron/util/StringUtil.cpp

${OBJECTDIR}/src/tron/util/Try.o: src/tron/util/Try.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/util
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/util/Try.o src/tron/util/Try.cpp

${OBJECTDIR}/src/tron/util/groups/Element.o: src/tron/util/groups/Element.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/util/groups
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/util/groups/Element.o src/tron/util/groups/Element.cpp

${OBJECTDIR}/src/tron/util/groups/Group.o: src/tron/util/groups/Group.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/util/groups
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/util/groups/Group.o src/tron/util/groups/Group.cpp

${OBJECTDIR}/src/tron/util/groups/SuperGroup.o: src/tron/util/groups/SuperGroup.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/util/groups
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/util/groups/SuperGroup.o src/tron/util/groups/SuperGroup.cpp
