...
${OBJECTDIR}/src/tron/cv/Distance2.o: src/tron/cv/Distance2.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/cv/Distance2.o src/tron/cv/Distance2.cpp

${OBJECTDIR}/src/tron/cv/Matrix.o: src/tron/cv/Matrix.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/cv
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/cv/Matrix.o src/tron/cv/Matrix.cpp

${OBJECTDIR}/src/tron/cv/area.o: src/tron/cv/area.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/cv
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/cv/area.o src/tron/cv/area.cpp

${OBJECTDIR}/src/tron/cv/average.o: src/tron/cv/average.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/cv
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/cv/average.o src/tron/cv/average.cpp

${OBJECTDIR}/src/tron/cv/distance.o: src/tron/cv/distance.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/cv
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/cv/distance.o src/tron/cv/distance.cpp
