...
${OBJECTDIR}/src/tron/diagram/Diagram.o: src/tron/diagram/Diagram.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/diagram/Diagram.o src/tron/diagram/Diagram.cpp

${OBJECTDIR}/src/tron/diagram/Path.o: src/tron/diagram/Path.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/diagram
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/diagram/Path.o src/tron/diagram/Path.cpp

${OBJECTDIR}/src/tron/diagram/State.o: src/tron/diagram/State.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/diagram
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/diagram/State.o src/tron/diagram/State.cpp

${OBJECTDIR}/src/tron/diagram/StatePk.o: src/tron/diagram/StatePk.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/diagram
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/diagram/StatePk.o src/tron/diagram/StatePk.cpp

${OBJECTDIR}/src/tron/diagram/Transition.o: src/tron/diagram/Transition.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/diagram
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/diagram/Transition.o src/tron/diagram/Transition.cpp

${OBJECTDIR}/src/tron/diagram/TransitionPk.o: src/tron/diagram/TransitionPk.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/diagram
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/diagram/TransitionPk.o src/tron/diagram/TransitionPk.cpp

${OBJECTDIR}/src/tron/diagram/Walker.o: src/tron/diagram/Walker.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/diagram
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/diagram/Walker.o src/tron/diagram/Walker.cpp
