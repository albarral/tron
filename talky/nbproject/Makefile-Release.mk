...
${OBJECTDIR}/src/talky/coms/Interpreter.o: src/talky/coms/Interpreter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/talky/coms
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/talky/coms/Interpreter.o src/talky/coms/Interpreter.cpp
...
${OBJECTDIR}/src/talky/coms/SlangTalker.o: src/talky/coms/SlangTalker.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/talky/coms
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/talky/coms/SlangTalker.o src/talky/coms/SlangTalker.cpp
...
${OBJECTDIR}/src/talky/coms/Talker.o: src/talky/coms/Talker.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/talky/coms
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/talky/coms/Talker.o src/talky/coms/Talker.cpp

${OBJECTDIR}/src/talky/concept/ArmTopic.o: src/talky/concept/ArmTopic.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/talky/concept
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/talky/concept/ArmTopic.o src/talky/concept/ArmTopic.cpp

${OBJECTDIR}/src/talky/concept/Topic.o: src/talky/concept/Topic.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/talky/concept
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/talky/concept/Topic.o src/talky/concept/Topic.cpp

${OBJECTDIR}/src/talky/language/ArmLanguage.o: src/talky/language/ArmLanguage.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/talky/language
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/talky/language/ArmLanguage.o src/talky/language/ArmLanguage.cpp

${OBJECTDIR}/src/talky/language/Language.o: src/talky/language/Language.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/talky/language
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/talky/language/Language.o src/talky/language/Language.cpp

${OBJECTDIR}/src/talky/language/Slang.o: src/talky/language/Slang.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/talky/language
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/talky/language/Slang.o src/talky/language/Slang.cpp

${OBJECTDIR}/src/talky/talk/Category.o: src/talky/talk/Category.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/talky/talk
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/talky/talk/Category.o src/talky/talk/Category.cpp

${OBJECTDIR}/src/talky/talk/Concept.o: src/talky/talk/Concept.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/talky/talk
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/talky/talk/Concept.o src/talky/talk/Concept.cpp

${OBJECTDIR}/src/talky/talk/TalkTopic.o: src/talky/talk/TalkTopic.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/talky/talk
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/talky/talk/TalkTopic.o src/talky/talk/TalkTopic.cpp
