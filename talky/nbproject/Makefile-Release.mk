...
${OBJECTDIR}/src/talky/coms/MessageBlock.o: src/talky/coms/MessageBlock.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/talky/coms
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/talky/coms/MessageBlock.o src/talky/coms/MessageBlock.cpp
...
${OBJECTDIR}/src/talky/languages/VisionLanguage.o: src/talky/languages/VisionLanguage.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/talky/languages
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/talky/languages/VisionLanguage.o src/talky/languages/VisionLanguage.cpp
...
${OBJECTDIR}/src/talky/topics/VisionTopic.o: src/talky/topics/VisionTopic.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/talky/topics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/talky/topics/VisionTopic.o src/talky/topics/VisionTopic.cpp
