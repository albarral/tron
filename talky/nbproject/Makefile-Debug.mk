...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libtron_talky.${CND_DLIB_EXT}
...
${OBJECTDIR}/src/talky/Talk2Target.o: src/talky/Talk2Target.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/talky
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/talky/Talk2Target.o src/talky/Talk2Target.cpp
...
${OBJECTDIR}/src/talky/coms/CommandQueue.o: src/talky/coms/CommandQueue.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/talky/coms
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/talky/coms/CommandQueue.o src/talky/coms/CommandQueue.cpp

${OBJECTDIR}/src/talky/coms/Conversion.o: src/talky/coms/Conversion.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/talky/coms
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/talky/coms/Conversion.o src/talky/coms/Conversion.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libtron_talky.${CND_DLIB_EXT}
