...
# Object Files
OBJECTFILES= \
	${OBJECTDIR}/src/tron/control/SensorLed.o \
...
${OBJECTDIR}/src/tron/control/SensorLed.o: src/tron/control/SensorLed.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/control
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/control/SensorLed.o src/tron/control/SensorLed.cpp
