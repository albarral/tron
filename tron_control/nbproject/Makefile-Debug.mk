...
${OBJECTDIR}/src/tron/control/brooks/control.o: src/tron/control/brooks/control.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/control/brooks
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/control/brooks/control.o src/tron/control/brooks/control.cpp

${OBJECTDIR}/src/tron/control/brooks/control1.o: src/tron/control/brooks/control1.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/control/brooks
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/control/brooks/control1.o src/tron/control/brooks/control1.cpp

${OBJECTDIR}/src/tron/control/brooks/control2.o: src/tron/control/brooks/control2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/control/brooks
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/control/brooks/control2.o src/tron/control/brooks/control2.cpp

${OBJECTDIR}/src/tron/control/brooks/control3.o: src/tron/control/brooks/control3.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/control/brooks
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/control/brooks/control3.o src/tron/control/brooks/control3.cpp

${OBJECTDIR}/src/tron/control/brooks/inhibition.o: src/tron/control/brooks/inhibition.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/control/brooks
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/control/brooks/inhibition.o src/tron/control/brooks/inhibition.cpp

${OBJECTDIR}/src/tron/control/brooks/sensor.o: src/tron/control/brooks/sensor.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/control/brooks
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/control/brooks/sensor.o src/tron/control/brooks/sensor.cpp

${OBJECTDIR}/src/tron/control/brooks/sensor2.o: src/tron/control/brooks/sensor2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/control/brooks
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/control/brooks/sensor2.o src/tron/control/brooks/sensor2.cpp

${OBJECTDIR}/src/tron/control/brooks/sensor3.o: src/tron/control/brooks/sensor3.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/control/brooks
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/control/brooks/sensor3.o src/tron/control/brooks/sensor3.cpp

${OBJECTDIR}/src/tron/control/module.o: src/tron/control/module.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/control
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/control/module.o src/tron/control/module.cpp

${OBJECTDIR}/src/tron/control/module2.o: src/tron/control/module2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/control
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/control/module2.o src/tron/control/module2.cpp

${OBJECTDIR}/src/tron/control/module3.o: src/tron/control/module3.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/control
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/control/module3.o src/tron/control/module3.cpp
...
${OBJECTDIR}/src/tron/control/operators/ControlAdder3.o: src/tron/control/operators/ControlAdder3.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/control/operators/ControlAdder3.o src/tron/control/operators/ControlAdder3.cpp
