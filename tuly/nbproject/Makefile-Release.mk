...
${OBJECTDIR}/src/tuly/control/SensorLed.o: src/tuly/control/SensorLed.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tuly/control/SensorLed.o src/tuly/control/SensorLed.cpp
...
${OBJECTDIR}/src/tuly/utils2/CodeMap.o: src/tuly/utils2/CodeMap.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tuly/utils2/CodeMap.o src/tuly/utils2/CodeMap.cpp
