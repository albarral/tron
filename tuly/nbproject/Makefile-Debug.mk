...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libtron_tuly.${CND_DLIB_EXT}
...
${OBJECTDIR}/src/tuly/control/brooks/control.o: src/tuly/control/brooks/control.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tuly/control/brooks/control.o src/tuly/control/brooks/control.cpp

${OBJECTDIR}/src/tuly/control/brooks/inhibition.o: src/tuly/control/brooks/inhibition.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tuly/control/brooks
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tuly/control/brooks/inhibition.o src/tuly/control/brooks/inhibition.cpp

${OBJECTDIR}/src/tuly/control/module.o: src/tuly/control/module.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tuly/control
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tuly/control/module.o src/tuly/control/module.cpp

${OBJECTDIR}/src/tuly/control/module2.o: src/tuly/control/module2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tuly/control
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tuly/control/module2.o src/tuly/control/module2.cpp

${OBJECTDIR}/src/tuly/control/module3.o: src/tuly/control/module3.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tuly/control
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tuly/control/module3.o src/tuly/control/module3.cpp
...
${OBJECTDIR}/src/tuly/utils/FileReader.o: src/tuly/utils/FileReader.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tuly/utils
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tuly/utils/FileReader.o src/tuly/utils/FileReader.cpp

${OBJECTDIR}/src/tuly/utils/FileWriter.o: src/tuly/utils/FileWriter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tuly/utils
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tuly/utils/FileWriter.o src/tuly/utils/FileWriter.cpp

${OBJECTDIR}/src/tuly/utils/IntegerQueue.o: src/tuly/utils/IntegerQueue.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tuly/utils
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tuly/utils/IntegerQueue.o src/tuly/utils/IntegerQueue.cpp

${OBJECTDIR}/src/tuly/utils/MessageQueue.o: src/tuly/utils/MessageQueue.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tuly/utils
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tuly/utils/MessageQueue.o src/tuly/utils/MessageQueue.cpp

${OBJECTDIR}/src/tuly/utils/StringUtil.o: src/tuly/utils/StringUtil.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tuly/utils
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tuly/utils/StringUtil.o src/tuly/utils/StringUtil.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libtron_tuly.${CND_DLIB_EXT}
