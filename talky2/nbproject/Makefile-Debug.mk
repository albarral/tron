...
${OBJECTDIR}/src/tron/talky2/channel/ChannelSuscriber.o: src/tron/talky2/channel/ChannelSuscriber.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/talky2/channel
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../robot/src -I../tuly/src -I../wire/src -I../wire2/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/talky2/channel/ChannelSuscriber.o src/tron/talky2/channel/ChannelSuscriber.cpp
