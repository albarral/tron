...
${OBJECTDIR}/src/tron/talky2/BasicTalker.o: src/tron/talky2/BasicTalker.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../robot/src -I../tuly/src -I../wire/src -I../wire2/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/talky2/BasicTalker.o src/tron/talky2/BasicTalker.cpp
...
${OBJECTDIR}/src/tron/talky2/arm/ChannelSubscriber4Axes.o: src/tron/talky2/arm/ChannelSubscriber4Axes.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/talky2/arm
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../robot/src -I../tuly/src -I../wire/src -I../wire2/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/talky2/arm/ChannelSubscriber4Axes.o src/tron/talky2/arm/ChannelSubscriber4Axes.cpp

${OBJECTDIR}/src/tron/talky2/arm/ChannelSubscriber4Joints.o: src/tron/talky2/arm/ChannelSubscriber4Joints.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/talky2/arm
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../robot/src -I../tuly/src -I../wire/src -I../wire2/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/talky2/arm/ChannelSubscriber4Joints.o src/tron/talky2/arm/ChannelSubscriber4Joints.cpp
...
${OBJECTDIR}/src/tron/talky2/body/ArtisticTalker.o: src/tron/talky2/body/ArtisticTalker.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../robot/src -I../tuly/src -I../wire/src -I../wire2/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/talky2/body/ArtisticTalker.o src/tron/talky2/body/ArtisticTalker.cpp

${OBJECTDIR}/src/tron/talky2/body/BodyClient.o: src/tron/talky2/body/BodyClient.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/talky2/body
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../robot/src -I../tuly/src -I../wire/src -I../wire2/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/talky2/body/BodyClient.o src/tron/talky2/body/BodyClient.cpp

${OBJECTDIR}/src/tron/talky2/body/ExpressiveTalker.o: src/tron/talky2/body/ExpressiveTalker.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/talky2/body
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../robot/src -I../tuly/src -I../wire/src -I../wire2/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/talky2/body/ExpressiveTalker.o src/tron/talky2/body/ExpressiveTalker.cpp
...
${OBJECTDIR}/src/tron/talky2/channel/ChannelPublisher.o: src/tron/talky2/channel/ChannelPublisher.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/talky2/channel
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../robot/src -I../tuly/src -I../wire/src -I../wire2/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/talky2/channel/ChannelPublisher.o src/tron/talky2/channel/ChannelPublisher.cpp
...
${OBJECTDIR}/src/tron/talky2/channel/ChannelSubscriber.o: src/tron/talky2/channel/ChannelSubscriber.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/talky2/channel
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../robot/src -I../tuly/src -I../wire/src -I../wire2/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/talky2/channel/ChannelSubscriber.o src/tron/talky2/channel/ChannelSubscriber.cpp
