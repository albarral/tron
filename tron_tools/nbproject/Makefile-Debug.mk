...
${OBJECTDIR}/src/tron/tools/Console.o: src/tron/tools/Console.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/tools/Console.o src/tron/tools/Console.cpp

${OBJECTDIR}/src/tron/tools/FileReader.o: src/tron/tools/FileReader.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/tools
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/tools/FileReader.o src/tron/tools/FileReader.cpp
...
${OBJECTDIR}/src/tron/tools/ZeroPublisher.o: src/tron/tools/ZeroPublisher.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/tools
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/tools/ZeroPublisher.o src/tron/tools/ZeroPublisher.cpp
...
${OBJECTDIR}/src/tron/tools/ZeroSubscriber.o: src/tron/tools/ZeroSubscriber.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron/tools
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron/tools/ZeroSubscriber.o src/tron/tools/ZeroSubscriber.cpp
