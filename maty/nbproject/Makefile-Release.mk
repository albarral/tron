...
${OBJECTDIR}/src/maty/math/Distance2.o: src/maty/math/Distance2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/maty/math
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/maty/math/Distance2.o src/maty/math/Distance2.cpp
...
${OBJECTDIR}/src/maty/signals/VectorialOscillator.o: src/maty/signals/VectorialOscillator.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/maty/signals
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/maty/signals/VectorialOscillator.o src/maty/signals/VectorialOscillator.cpp
