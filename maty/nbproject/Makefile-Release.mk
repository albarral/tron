...
${OBJECTDIR}/src/amy/math/Angle.o: src/amy/math/Angle.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/math/Angle.o src/amy/math/Angle.cpp

${OBJECTDIR}/src/amy/math/ArmMath.o: src/amy/math/ArmMath.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/math
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/math/ArmMath.o src/amy/math/ArmMath.cpp
