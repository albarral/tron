...
${OBJECTDIR}/src/maty/math/CyclicComponent.o: src/maty/math/CyclicComponent.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/maty/math
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/maty/math/CyclicComponent.o src/maty/math/CyclicComponent.cpp

${OBJECTDIR}/src/maty/math/CyclicMath.o: src/maty/math/CyclicMath.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/maty/math
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/maty/math/CyclicMath.o src/maty/math/CyclicMath.cpp
