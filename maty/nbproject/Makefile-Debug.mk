...
${OBJECTDIR}/src/maty/moves/CircularMovement.o: src/maty/moves/CircularMovement.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/maty/moves/CircularMovement.o src/maty/moves/CircularMovement.cpp

${OBJECTDIR}/src/maty/moves/CyclicComponent.o: src/maty/moves/CyclicComponent.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/maty/moves
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/maty/moves/CyclicComponent.o src/maty/moves/CyclicComponent.cpp
